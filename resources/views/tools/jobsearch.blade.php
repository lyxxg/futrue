...
@section("content")
    ...
    <div id="objective">
        <h2>个人简历</h2>
        <img src="{{asset('futrue/job/lmx.jpg')}}" style="width:80px;height:79px;
    ...
    <div id="skillareas">
        ...
        <ol>
            <li class="skill">
                <h3>主要技能</h3>
                <ul class="skillset">
                    <li>PHP Laravel 队列 缓存 文件缓存 <a href="{{asset('article')}}">此站</a>就是<span class="only">本人独自花费3个多月</span>使用这些技术完成的</li>
