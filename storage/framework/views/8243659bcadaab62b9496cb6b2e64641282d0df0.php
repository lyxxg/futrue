...
<div class="sidebar">
    ...
    <div class="s-content">
        ...
        <ul id="nav">
            ...
            <?php else: ?>
                <li style="margin-right: 8px"><a href="<?php echo e(route('user.index',['user_id'=>Auth::id()])); ?>"
                    class="br-yellow">
                        <img  src="<?php echo e(\Illuminate\Support\Facades\Storage::url(Auth::user()->info->avatar)); ?>" class="avatar1"
