...
<?php if(\App\Models\Follower::where("user_id",Auth::id())->where("follower_id",$user->id)->first()==null): ?>

                        <form action="<?php echo e(route('attention.store')); ?>" method="post">
   <?php echo e(csrf_field()); ?>
    ...
    <?php else: ?>
                            <form action="<?php echo e(route('attention.destroy',$user->id)); ?>" method="post">
                                <?php echo e(csrf_field()); ?>
...
<?php endif; ?>
                ...
                <div class="bottom">
                    ...
                    <ul class="social_links">
                        ...
                        <li class="pinterest animated bounceIn wow delay-04s animated" style="visibility: visible; animation-name: bounceIn;"><a href="<?php echo e(route("attention.index",['user_id'=>$user->id])); ?>">粉丝</a></li>
