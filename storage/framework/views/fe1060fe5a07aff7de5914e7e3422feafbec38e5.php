            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <?php if(!in_array($user->id,$rolearr)): ?>
                                <a href="#" class="btn  btn-primary btn-add" title="添加管理员">添加管理员</a>
                                <form onsubmit="return confirm('您是否确定要将该用户添加到管理员')" action="<?php echo e(route('admin.roles.store',$user->id)); ?>"  method="post">
                            ...
                            <?php else: ?>
                                <a href="#" class="btn btn-danger btn-sm btn-del" title="取消管理员">取消管理员</a>
                                <form onsubmit="return confirm('您是否确定要取消改管理员?')" action="<?php echo e(route('admin.roles.destroy',$user->id)); ?>"  method="post">
