            ...
            <div class="span4">
                <div class="fwidget">
                    ...
                    <div class="col-l">
                        <h6>工具</h6>
                        <ul>
                            <li><a href="<?php echo e(route('blbl')); ?>">b站封面获取</a></li>
                            <li><a href="<?php echo e(route('qrview')); ?>">二维码识别</a></li>
                            <li><a href="#">暂无</a></li>
                            <li><a href="#">暂无</a></li>
                            <li><a href="#">暂无</a></li>
                        </ul>
                    ...
                    <div class="col-r">
                        <h6>关于</h6>
                        <ul>
                            <li><a href="<?php echo e(route('wechatpublic')); ?>">公众号</a></li>
                            <li><a href="#">暂无</a></li>
                            <li><a href="<?php echo e(route('contactme')); ?>">联系我</a></li>
                            <li><a href="#">暂无</a></li>
                            <li><a href="#">暂无</a></li>
                        </ul>
                    </div>
...
<script src="<?php echo e(asset('futrue/js/futruetheme.js')); ?>"></script>
<script src="<?php echo e(asset('futrue/js/avatar.js')); ?>"></script>
