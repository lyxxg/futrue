        ...
        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="meta">
                <a href="<?php echo e(route('user.index',['user_id'=>$article->question->user_id])); ?>"> <i class="fa fa-user"></i><?php echo e($article->question->user->name); ?> </a>
                    <a href="<?php echo e(route("tag.show",$article->tag)); ?>"><i class="fa fa-tag"></i><?php echo e($article->tag->name); ?></a>
                    <!--加个标签链接-->
                <i class="fa fa-calendar"></i> <?php echo e($article->question->created_at->diffForHumans()); ?>

                <span class="pull-right">
                                <i class="fa fa-eye"></i> <?php echo e($article->question->view); ?>

                    <a href="#"><i class="fa fa-comment"></i> <?php echo e($article->question->answer); ?></a>
                            </span>
